...
- No logo vector exists; only a 192px favicon (`public/photos/logo-mark-192.png`). The wordmark and any crest must be authored, and an official vector is on the replacement list.
